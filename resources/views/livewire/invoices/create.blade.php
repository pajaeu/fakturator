<div>
    <x-header>
        ...
        <x-slot:buttons>
            <x-button href="{{ route('invoices.index') }}" :link="true" variant="outline">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 lg:gap-20">
            ...
            <div>
                <div class="flex gap-4 mb-4">
                    ...
                    <div class="w-full">
                        <x-form.input wire:model.blur="issued_at" @class(['border-red-500' => $errors->has('issued_at')])/>
                ...
                <div class="flex gap-4 mb-4">
                    ...
                    <div class="w-full">
                        <x-form.input wire:model.blur="due_at" @class(['border-red-500' => $errors->has('due_at')])/>
