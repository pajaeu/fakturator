<x-card>
    <div class="mb-5">
        <div class="hidden md:flex gap-2 mb-2 text-sm text-gray-600 font-semibold items-center">
            <div class="w-10"></div>
        ...
        <div x-data="{
            ...
            @foreach($items as $index => $item)
                <div wire:key="item_{{ $index }}" class="flex flex-col md:flex-row gap-2 mb-2 md:items-center" data-id="{{ $index }}">
                    <div class="w-10">
