<div class="relative" x-data="{ show: false }">
    ...
    <div class="absolute top-full right-0 mt-2 z-10 py-2 rounded-lg w-max min-w-[100px] border border-gray-200 bg-white" x-show="show" x-cloak @click.outside.window="show = false">
        {{ $items }}
    </div>
</div>